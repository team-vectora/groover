    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div ref={popupRef} className="bg-bg-secondary rounded-xl w-full max-w-md border border-primary">
        <div className="flex justify-between items-center px-5 py-4 border-b border-primary">
          <h3 className="text-lg font-semibold text-accent-light">Configurar Perfil</h3>
        ...
        <form onSubmit={handleSubmit} className="p-5">
          <div className="mb-5">
            <label className="block mb-2 text-sm text-gray-300">Foto de perfil</label>
          ...
          <div className="mb-5">
            <label className="block mb-2 text-sm text-gray-300">Escolha até 5 gêneros musicais</label>
