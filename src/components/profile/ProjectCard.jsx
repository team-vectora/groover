...
const ProjectCard = ({ isYourProfile, project, setCurrentProject, handleClickShare, handleClickDelete }) => {
    ...
    return (
        <div
            ...
            className="relative flex flex-col md:flex-row items-center gap-4 p-4 pr-5
        ...
        >
            ...
            {isYourProfile && (
                <div ref={menuRef} className="absolute top-0 right-1 z-10">
                    <button
                        ...
                        className="text-gray-400 hover:text-white p-2 rounded-full hover:bg-primary/30 transition"
                    >
                        <FontAwesomeIcon icon={faEllipsisVertical} />
                    </button>
                    {isMenuOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-bg-darker border border-primary rounded-md shadow-lg z-20">
                            <button
                                // A funcionalidade será implementada futuramente
                                onClick={(e) => e.stopPropagation()}
                                className="w-full text-left px-4 py-2 text-sm text-foreground hover:bg-primary/20 flex items-center gap-2"
                            >
            ...
            {/* --- Imagem da Capa (Tamanho Reduzido) --- */}
            ...
            <div className="flex-1 flex flex-col justify-between w-full">
                <div>
                    <h2 className="text-lg md:text-xl font-bold text-accent-light line-clamp-2">
                ...
                {/* --- Botões de Ação (sem o de deletar) --- */}
